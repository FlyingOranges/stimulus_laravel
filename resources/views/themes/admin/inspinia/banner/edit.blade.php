    ...
    <div class="row wrapper border-bottom white-bg page-heading">
        <div class="col-lg-10">
            ...
            <ol class="breadcrumb">
                ...
                <li class="active">
                    <strong>{!! trans('common.edit').trans('banner.slug') !!}</strong>
                </li>
            </ol>
        </div>
        <div class="col-lg-2">
            ...
            <div class="col-lg-12">
                <div class="ibox float-e-margins">
                    ...
                    <div class="ibox-content">
                        ...
                        <form method="post" action="{{ route('banners.update', [encodeId($data->id, 'id')]) }}"
                            ...
                            <div class="form-group{{ $errors->has('src') ? ' has-error' : '' }}">
                                ...
                                <div class="col-sm-10">
                                    <img src="{{ old('src', getCover($data->src)->path) }}" class="img-default">

                                    <input type="file" class="img-banner" name="src" style="display: none;">
                                    @if ($errors->has('src'))
                            ...
                            <div class="form-group">
                                <div class="col-sm-4 col-sm-offset-2">
                                    ...
                                    @if(haspermission('bannerscontroller.update'))
